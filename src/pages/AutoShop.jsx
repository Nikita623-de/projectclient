...
const AutoShop = observer(() => {
  ...
  React.useEffect(() => {
    ...
    fetchProducts(null, null, null, null, null, null, null, null, 1, 6).then((data) => {
  ...
  React.useEffect(() => {
    fetchProducts(
      product.selectedWidth.id,
      product.selectedBrand.id,
      product.selectedHeight.id,
      product.selectedDiametr.id,
      product.selectedSpeed.id,
      product.selectedIndex.id,
      product.selectedThorn.id,
      product.selectedSeasonality.id,
      product.page,
      6,
    ).then((data) => {
      product.setProducts(data.rows);
    ...
    product.selectedDiametr,
    product.selectedSpeed,
    product.selectedIndex,
    product.selectedThorn,
    product.selectedSeasonality,
  ]);
  React.useEffect(() => {
