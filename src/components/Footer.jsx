      ...
      <div className="container">
        <div className="footer__top">
          <div className="footer__block">
            <strong className="footer__subtitle">Реквизиты</strong>
            <span className="footer__requisite">
              Наименование компании/ИП ВОЛОШАНОВСКИЙАРТУРСЕРГЕЕВИЧ (ИП)
            </span>
            <span className="footer__requisite">ИНН компании/ИП 591794638027</span>
          </div>
          <div className="footer__block">
            <strong className="footer__subtitle">Контакты</strong>
            <a href="tel: +8 992 333-00-98" className="footer__link">
              Телефон: +7 992 333-00-98
            </a>
            <a href="mailto:Forward663@yandex.ru" className="footer__link">
              E-mail: Forward663@yandex.ru
            </a>
            <span className="footer__span">Время работы: пн-вс 9:00-21:00</span>
            <span className="footer__span">Заходите: ул Краснолесья 19, Екатеринбург</span>
          </div>
        </div>
        <div className="footer__bottom">
          <Link to="/about" className="logo footer__logo">
            ВАМ КОЛЁСА
          </Link>
          <a href="https://wa.me/89923330098" className="social footer__social">
            <svg
              width="14"
              height="14"
              viewBox="0 0 14 14"
